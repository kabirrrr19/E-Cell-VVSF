    ...
    <>
      <section id="about" >
        <div>
          <div
            style={myStyle1}
            className="bg-gradient-to-l from-gray-900 max-w-screen-2xl to-gray-700 mx-auto max-w-screen-xl px-4 py-8 sm:py-12 sm:px-6 lg:py-16 lg:px-full"
          >
        ...
        <div style={myStyle2} className="bg-gradient-to-r pb-6 from-gray-900 max-w-screen-2xl to-gray-700 mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-full">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
